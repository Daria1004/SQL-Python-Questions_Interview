...
### Ответ:
1) убедиться, что для этого клиента есть последний заказ
2) проверить номер заказа в теле запроса
3) что этот заказ последний относится к этому клиенту
4) действительно ли это последний заказ
5) совпадает ли сумма
